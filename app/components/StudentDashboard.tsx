...
import CourseMarks from "./student/CourseMarks"
import CourseRemarks from "./student/CourseRemarks"
...
const renderAttendanceTab = () => <AttendanceOverview userId={auth?.user?.userId || ""} />
